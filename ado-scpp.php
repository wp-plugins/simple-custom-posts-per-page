...
Plugin URI: http://www.adostudio.it/
Description: This plugin allows to configure how many posts display for every custom post registred.
Version: 1.0
...
function ado_cspp_build_section(){
	...
	echo "<br />".__("If in your template you need disable the standard number of custom posts for a type set by plugin, you can use the following code before your custom query",'ado-scpp');
