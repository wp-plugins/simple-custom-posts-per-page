...
This plugin allows to configure the number of posts displaied for every custom post registered.

== Description ==

Simple Custom Posts per Page (SCPP) allows to configure the number of posts displaied for every custom post registered in Wordpress.
